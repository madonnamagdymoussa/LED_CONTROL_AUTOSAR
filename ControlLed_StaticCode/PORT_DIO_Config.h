#ifndef PORT_DIO_CONFIG_H_
#define PORT_DIO_CONFIG_H_
 ...
 * then thse enum name must end with Mode_t
...
/*                                    TYPEDEF                                           */
/* =====================================================================================*/
typedef  u8_t   PortType;
typedef  u8_t   Port_PinType;
typedef  u8_t   Port_NumID;


#endif /* PORT_DIO_CONFIG_H_ */
