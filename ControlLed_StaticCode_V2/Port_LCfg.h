...
typedef struct
{
    u8_t*  baseAddress;    /*The base address which refers to the UserMapArrayIds*/
    u8_t   offset;         /*The number of mapped elements*/
...
*/
extern u8_t lcfg_PortConfigSet_size;

/*
* PortContainer Container
*   Extern Size Variable
*/
extern u8_t lcfg_PortContainer_size;

/*
* PortPin Container
*   Extern Size Variable
*/
extern u8_t lcfg_PortPin_size;
